        ...
        case_rows.append(
            {
                ...
                "hmc_mass_spatial_shell_map": case["hmc"].get("hmc_mass_spatial_shell_map", ""),
                "hmc_hybrid_local_sweeps": case["hmc"].get("hmc_hybrid_local_sweeps", 0),
            ...
            candidate_rows.append(
                {
                    ...
                    "hmc_mass_spatial_shell_map": row.get("hmc_mass_spatial_shell_map", ""),
                    "hmc_hybrid_local_sweeps": row.get("hmc_hybrid_local_sweeps", 0),
        ...
        recommended_rows.append(
            {
                ...
                "hmc_mass_spatial_shell_map": rec.get("hmc_mass_spatial_shell_map", ""),
                "hmc_hybrid_local_sweeps": rec.get("hmc_hybrid_local_sweeps", 0),
...
def write_report(
    ...
    def fill_hmc_defaults(row: dict[str, object]) -> dict[str, object]:
        ...
        row.setdefault("hmc_mass_spatial_shell_map", "")
        row.setdefault("hmc_hybrid_local_sweeps", 0)
        return row
    ...
    lines.extend(
        ...
        "## Stage Summary",
        "",
        "| label | case | beta | dtau | repeats | bins | cut | warm | samples/post | max drift | repeat span | nfrog | dt | mass | m_uniform | m_lowk | lowk_shells | m_midk | midk_shells | shell_map | hybrid_local | m_shell1 | m_shell2 | acceptance | tau_int(doubleOcc) | ESS/sec | status |",
        "| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |",
        ]
    )
    ...
    lines.extend(
        [
            ...
            "",
            "| label | case | beta | dtau | viable | nfrog | dt | mass | m_uniform | m_lowk | lowk_shells | m_midk | midk_shells | shell_map | hybrid_local | m_shell1 | m_shell2 | acceptance | tau_int(doubleOcc) | ESS/sec | DeltaH_abs_max |",
            "| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
        ]
    )
...
def main() -> int:
    ...
    write_csv(
        ...
        tune_candidates,
        ["label", "work_root", "case", "beta", "dtau", "nfrog", "hmc_dt", "hmc_mass", "hmc_mass_spatial_uniform", "hmc_mass_spatial_lowk", "hmc_mass_spatial_lowk_shells", "hmc_mass_spatial_midk", "hmc_mass_spatial_midk_shells", "hmc_mass_spatial_shell1", "hmc_mass_spatial_shell2", "hmc_mass_spatial_shell_map", "hmc_hybrid_local_sweeps", "acceptance_mean", "tau_int_doubleOcc_mean", "ess_per_sec_doubleOcc_mean", "hmc_deltaH_abs_max"],
    )
    write_csv(
