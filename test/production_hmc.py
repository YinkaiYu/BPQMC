...
def get_hmc_params(
...
) -> tuple[int, float, int, float, float, float, int, float, int, float, float]:
    if case_name in tuned_map:
        ...
        return (
            ...
            float(params.get("hmc_mass_spatial_midk", 0.0)),
            int(params.get("hmc_mass_spatial_midk_shells", 0)),
    ...
    return (
        ...
        args.hmc_mass_spatial_midk,
        args.hmc_mass_spatial_midk_shells,
...
def hmc_env_overrides(
    ...
    hmc_mass_spatial_midk: float,
    hmc_mass_spatial_midk_shells: int,
    ...
    return {
        ...
        "BPQMC_HMC_MASS_SPATIAL_MIDK": f"{hmc_mass_spatial_midk:.16g}",
...
def aggregate_tune_repeat_rows(repeat_rows: list[dict[str, float | int | str]]) -> dict[str, float | int | str]:
    summary: dict[str, float | int | str] = {
        ...
        "hmc_mass_spatial_midk": repeat_rows[0]["hmc_mass_spatial_midk"],
        "hmc_mass_spatial_midk_shells": repeat_rows[0]["hmc_mass_spatial_midk_shells"],
...
def collect_stage_case(
    ...
    *,
    ...
    nfrog, hmc_dt, jitter, hmc_mass, hmc_mass_spatial_uniform, hmc_mass_spatial_lowk, hmc_mass_spatial_lowk_shells, hmc_mass_spatial_midk, hmc_mass_spatial_midk_shells, hmc_mass_spatial_shell1, hmc_mass_spatial_shell2 = get_hmc_params(cfg.name, args, tuned_map)
    ...
    for repeat, seed in enumerate(seed_bases):
        ...
        print(
            "  [{mode}] repeat={repeat} seed={seed} nfrog={nfrog} dt={dt:.6g} mass={mass:g} uniform_mass={uniform_mass:g} lowk_mass={lowk_mass:g} lowk_shells={lowk_shells} midk_mass={midk_mass:g} midk_shells={midk_shells} shell1_mass={shell1_mass:g} shell2_mass={shell2_mass:g}".format(
                ...
                midk_mass=hmc_mass_spatial_midk,
                midk_shells=hmc_mass_spatial_midk_shells,
        ...
        repeat_row = {
            ...
            "hmc_mass_spatial_midk": hmc_mass_spatial_midk,
            "hmc_mass_spatial_midk_shells": hmc_mass_spatial_midk_shells,
...
def stage_config_payload(args: argparse.Namespace) -> dict[str, object]:
    return {
        ...
        "hmc_mass_spatial_midk": args.hmc_mass_spatial_midk,
        "hmc_mass_spatial_midk_shells": args.hmc_mass_spatial_midk_shells,
...
def run_tune_or_collect(args: argparse.Namespace, *, execute: bool) -> int:
    ...
    for cfg in configs.values():
        ...
        print(
            ...
            f"midk_mass={args.hmc_mass_spatial_midk:g} midk_shells={args.hmc_mass_spatial_midk_shells} shell1_mass={args.hmc_mass_spatial_shell1:g} "
    ...
    tuned_map = {
        case["name"]: {
            ...
            "hmc_mass_spatial_midk": case["recommended"].get("hmc_mass_spatial_midk", 0.0),
            "hmc_mass_spatial_midk_shells": case["recommended"].get("hmc_mass_spatial_midk_shells", 0),
            ...
            for mode_name, is_global in (("local", False), ("hmc", True)):
                ...
                run_case(
                    ...
                    env_overrides=hmc_env_overrides(
                        ...
                        hmc_mass_spatial_midk if is_global else 0.0,
                        hmc_mass_spatial_midk_shells if is_global else 0,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    tune.add_argument("--hmc-mass-spatial-midk", type=float, default=0.0)
    tune.add_argument("--hmc-mass-spatial-midk-shells", type=int, default=0)
    ...
    collect_tune_parser.add_argument("--hmc-mass-spatial-midk", type=float, default=0.0)
    collect_tune_parser.add_argument("--hmc-mass-spatial-midk-shells", type=int, default=0)
    ...
    bench.add_argument("--hmc-mass-spatial-midk", type=float, default=0.0)
    bench.add_argument("--hmc-mass-spatial-midk-shells", type=int, default=0)
    ...
    def add_stage_args(subparser: argparse.ArgumentParser) -> None:
        ...
        subparser.add_argument("--hmc-mass-spatial-midk", type=float, default=0.0)
        subparser.add_argument("--hmc-mass-spatial-midk-shells", type=int, default=0)
