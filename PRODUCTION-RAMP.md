...
- When static Fourier-mass tuning stops helping, allow a small number of hybrid local sweeps
  between HMC proposals before escalating to a more invasive integrator rewrite.
